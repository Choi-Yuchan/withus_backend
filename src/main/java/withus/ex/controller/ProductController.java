...
import withus.ex.VO.MemberVO;
import withus.ex.VO.OrderDetailVO;
import withus.ex.VO.OrderListVO;
import withus.ex.VO.OrderVO;
import withus.ex.VO.ReplyListVO;
import withus.ex.VO.ReplyVO;
import withus.ex.VO.ShopService;
...
// 회원가입 처리
    ...
    public String registerMember(UsersVO member) {
